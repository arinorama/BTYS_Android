 ...
 * interface.
 */
public class VehicleListFragment extends Fragment implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener{

    private Context context;

    private String TITLE = "Araç Listesi";
    ...
    private VehicleListRecyclerViewAdapter _adapter;

    VehicleListData _vehicleList;
    VehicleListFragmentState _fragmentState;
    ...
    public static VehicleListFragment newInstance(boolean loadDataFromDB, Context context) {
    ...
    private void restoreFragmentState(){
        ...
        showVehicleListData(DataCache.getInstance().get_vehicleListData());
    }
    ...
    private void saveFragmentState(){
        ...
        _fragmentState = new VehicleListFragmentState(_filterText, DataCache.getInstance().get_vehicleListData());
    }
    ...
    private void loadDataFromDB(){
        ...
        if (_datacache.get_vehicleListData() != null){
            showVehicleListData(_datacache.get_vehicleListData());
        }
        //yoksa yeniden yukle
        else {
            ...
            _hrUsers.getVehicleList(new onGetVehicleList());
        }
    }
...
//            ApplicationHelpers.getInstance(getContext()).handleError("VehicleListFragment: hata: onGetRepairProjectsListData - DATA yok");
        ...
        showVehicleListData(event.getData());
     ...
     * @param data
     */
    private void showVehicleListData(Object data){
        //sonradan tekrar sayfaya donulurse, tekrar bilgileri yuklememek icin datayi cache atiyoruz
        DataCache.getInstance().set_vehicleListData(data);

        //datayi JSONArray e cevirip recycleriew e atiyoruz
        JSONArray _jaVehicleList = (JSONArray) data;
        _vehicleList = new VehicleListData(_jaVehicleList);
        _adapter = new VehicleListRecyclerViewAdapter(_vehicleList.ITEMS, mListener);
...
//endregion
    ...
    public interface OnListFragmentInteractionListener {
        void onListFragmentInteraction(VehicleListItem item);
    }

    private class VehicleListFragmentState{
        private Object _vehicleListDataState;
        private String _filterText;

        public VehicleListFragmentState(String filterText, Object vehicleListDataState){
            _filterText = filterText;
            _vehicleListDataState = vehicleListDataState;
        }
        ...
        public Object get_vehicleListDataState() {
            return _vehicleListDataState;
        }
    }
}
